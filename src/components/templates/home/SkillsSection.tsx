  ...
  const skillsList = {
    'front-end': [
      ...
      },
      {
        ...
        name: 'Next.js',
        level: 80,
        logo: '/images/skill/nextjs.png',
      },
      {
        id: 3,
        name: 'Tailwind CSS',
        level: 90,
        logo: '/images/skill/Tailwind%20CSS.png',
      },
      {
        id: 4,
        name: 'TypeScript',
    ...
    'back-end & database': [
      {
        ...
        name: 'Node.js',
        level: 70,
        logo: '/images/skill/Node.png',
      },
      {
        id: 7,
        name: 'Nest.js',
        level: 65,
        logo: '/images/skill/Nest.png',
      },
      {
        id: 8,
        name: 'MongoDB',
        level: 75,
        logo: '/images/skill/MongoDB.png',
      },
      {
        id: 9,
        name: 'PostgreSQL',
    ...
    'mobile development': [
      {
        ...
        name: 'Android studio',
        level: 80,
        logo: '/images/skill/Android%20Studio.png',
      },
      {
        id: 11,
        name: 'Kotlin',
        level: 75,
        logo: '/images/skill/Kotlin.png',
      },
      {
        id: 12,
        name: 'PWA',
        level: 70,
        logo: '/images/skill/pwa.png',
      },
      {
        id: 13,
        name: 'React Native',
    ...
    'tools & devops': [
      {
        ...
        name: 'Figma',
        level: 80,
        logo: '/images/skill/Figma.png',
      },
      {
        id: 15,
        name: 'XD',
        level: 95,
        logo: '/images/skill/Adobe%20XD.png',
      },
      {
        id: 16,
        name: 'Git & GitHub',
